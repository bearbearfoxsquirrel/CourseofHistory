...
public class Scaler {
    ...
    public void scaleToScreen(Scalable.ImageScalable scalable) {
        ...
        scalable.getMatrix().postScale((scalable.getWidth() / scalable.getBitmap().getWidth()) * scaleFactorX,
                (scalable.getHeight() / scalable.getBitmap().getHeight()) * scaleFactorY);
        scalable.getMatrix().postRotate(0, scaleFactorX * scalable.getBitmap().getWidth()/ 2.0f,
                scaleFactorY * scalable.getBitmap().getHeight() / 2.0f);

...
//        this.frameBuffer = frameBuffer;
    ...
    //clears and extracts rgb components from the specified
    //32-bit ARGB colour parameter and calls Canvas.drawRGB()
                            ...
                            int srcWidth, int srcHeight)
    {
        ...
        //cast to AndroidPixmap to get bitmap member

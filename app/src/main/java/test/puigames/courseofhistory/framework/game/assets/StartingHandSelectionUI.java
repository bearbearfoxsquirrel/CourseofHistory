...
public class StartingHandSelectionUI extends UIElement {
    ...
    public StartingHandSelectionUI(Screen screen, final Player player, Bitmap uIBackground, Bitmap confirmationButtonBitmap, Bitmap selectedCardToTossOverlay) {
    ...
    public StartingHandSelectionUI(Screen screen, Placer placer, final Player player, Bitmap uIBackground, Bitmap confirmationButtonBitmap) {
        super(screen, uIBackground, STARTING_HAND_SELECTOR_WIDTH, STARTING_HAND_SELECTOR_HEIGHT);
        this.player = player;
        this.placer = placer;

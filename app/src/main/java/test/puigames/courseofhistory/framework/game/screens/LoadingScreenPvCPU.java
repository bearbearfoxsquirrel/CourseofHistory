...
import test.puigames.courseofhistory.framework.game.levels.PvCPULevel;

/**
 * Created by Christopher on 08/05/2017.
 */

public class LoadingScreenPvCPU extends Menu {
    ...
    public LoadingScreenPvCPU(final GameProperties gameProperties){
    ...
    public void update(float deltaTime) {
        ...
        if(duration > delay)
            gameProperties.setScreen(new PvCPULevel(this.gameProperties));
